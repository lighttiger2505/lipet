...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.lipet.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".lipet" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".lipet")
	}
